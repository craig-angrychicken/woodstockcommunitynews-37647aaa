...
Woodstock Wire 2.0 is a private admin tool for AI-driven local news generation serving Woodstock, NY. It automates the full editorial pipeline — from scraping RSS feeds to publishing finished articles on Ghost CMS — with human review as an optional final gate.
