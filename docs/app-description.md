...
Woodstock Community News is a private admin tool for AI-driven local news generation serving Woodstock, Georgia and Cherokee County. It automates the full editorial pipeline — from scraping RSS feeds to publishing finished articles on Ghost CMS — with human review as an optional final gate.
