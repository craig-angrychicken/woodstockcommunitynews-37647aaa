/**
 * Woodstock Wire Pipeline Monitor Agent
 *
...
const FROM_EMAIL = "Woodstock Wire Monitor <alerts@woodstockwire.com>";
...
const tools = [
  {
    name: "query_database",
    description:
      "Execute a read-only SQL query against the Woodstock Wire production database. Returns an array of rows or an error object.",
    input_schema: {
      type: "object",
      properties: {
        sql: {
...
const SYSTEM_PROMPT = `You are the autonomous pipeline monitor for Woodstock Wire 2.0, a private AI-generated local news service for Woodstock, Georgia and Cherokee County.
...
1. Header — "Woodstock Wire Daily Briefing" + date ET, background #1a1a2e, white text
...
6. Footer — UTC timestamp + "Generated by Woodstock Wire Pipeline Monitor"
